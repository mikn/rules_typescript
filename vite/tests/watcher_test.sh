#!/usr/bin/env bash
# watcher_test.sh — hermetic wrapper for watcher_test.mjs.
#
#   bazel test //vite/tests:watcher_test --test_output=all
#
# Everything the test watches is written under TEST_TMPDIR by the .mjs, so this
...
TEST_MJS="${RUNFILES}/vite/tests/watcher_test.mjs"
