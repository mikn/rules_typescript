...
// rolled-up member keeps the src/ prefix its ts_compile rolled up, the
// per-directory one does not. A hub label that reached a different target in
// either directory would stage neither file.
