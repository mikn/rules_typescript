...
- **Gazelle generates the BUILD files** — targets inferred from the directory tree, imports resolved to labels, lint and dev-server targets generated, codegen auto-detected. Fifteen `# gazelle:ts_*` directives configure it.
