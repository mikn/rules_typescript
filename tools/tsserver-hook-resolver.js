 ...
 * bazel-out. It holds first-party packages and path aliases; npm resolves
 * through the checkout's node_modules. Nothing here runs Bazel, and nothing
 * here needs the data to exist.
 *
 * Design constraints:
...
function createResolutionSource({ workspaceRoot, workerPath, onUpdate }) {
  // Key:   a first-party package path ("src/utils"), or "__alias__<prefix>"
  //        for a ts_path_alias prefix mapped to a source directory.
