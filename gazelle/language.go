	...
	return []rule.LoadInfo{
		{
			...
			Symbols: []string{"asset_library", "css_library", "css_module", "json_library", "ts_codegen", "ts_compile", "ts_dev_server", "ts_lint", "ts_test"},
		},
	}
}
...
func (l *tsLang) Kinds() map[string]rule.KindInfo {
	return map[string]rule.KindInfo{
		...
		// Gazelle merges the srcs and outs attrs; generator/args are considered
		// user-managed after initial generation (not auto-updated).
		"ts_codegen": {
			MatchAny:   false,
			MatchAttrs: []string{"name"},
			NonEmptyAttrs: map[string]bool{
