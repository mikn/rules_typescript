...
TsDeclarationInfo = provider(
    ...
    fields = {
        "declaration_files": "depset of File: declaration files this target produces, plus the ambient ones it passes through from srcs; on an npm package, its module entry too when that is a `.ts`.",
