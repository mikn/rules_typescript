...
def _generate_vite_config(ctx, entry_js_file, bundle_filename, out_dir_rel, transitive_js_files, app_mode = False, user_config_file = None, has_staging_srcs = False, public_dir_rel = None, manifest = False):
